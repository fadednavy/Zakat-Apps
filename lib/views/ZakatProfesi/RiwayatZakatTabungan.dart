...
class RiwayatZakatProfesi extends StatefulWidget {
  @override
  _RiwayatZakatProfesiState createState() => _RiwayatZakatProfesiState();
}

class _RiwayatZakatProfesiState extends State<RiwayatZakatProfesi> {
  ...
  Future<void> _lihatData() async {
    ...
    final responseData = await http.post(
        Uri.parse(BaseURL.apiListZakatProfesi + idUsers),
        body: {"userid": idUsers});
