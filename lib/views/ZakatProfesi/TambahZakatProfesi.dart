...
class TambahZakatProfesi extends StatefulWidget {
  @override
  _TambahZakatProfesiState createState() => _TambahZakatProfesiState();
}

class _TambahZakatProfesiState extends State<TambahZakatProfesi> {
  ...
  simpanTransaksi() async {
    try {
      final response = await http.post(Uri.parse(BaseURL.addZakatProfesi),
      ...
      if (code == 201 || code == 200) {
        ...
        setState(() {
          var route = new MaterialPageRoute(
            builder: (BuildContext context) => new RingkasanZakatProfesi(
...
class RingkasanZakatProfesi extends StatefulWidget {
  final String nominal, pembayaran;

  RingkasanZakatProfesi({Key, key, this.nominal, this.pembayaran})
      : super(key: key);
  @override
  _RingkasanZakatProfesiState createState() => _RingkasanZakatProfesiState();
}

class _RingkasanZakatProfesiState extends State<RingkasanZakatProfesi> {
  @override
  signOut() async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    setState(() {
