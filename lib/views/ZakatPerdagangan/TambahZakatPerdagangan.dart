...
class TambahZakatPerdagangan extends StatefulWidget {
  @override
  _TambahZakatPerdaganganState createState() => _TambahZakatPerdaganganState();
}

class _TambahZakatPerdaganganState extends State<TambahZakatPerdagangan> {
  ...
  simpanTransaksi() async {
    try {
      final response = await http.post(Uri.parse(BaseURL.addZakatPerdagangan),
      ...
      if (code == 201 || code == 200) {
        ...
        setState(() {
          var route = new MaterialPageRoute(
            builder: (BuildContext context) => new RingkasanZakatPerdagangan(
...
class RingkasanZakatPerdagangan extends StatefulWidget {
  final String nominal, pembayaran;

  RingkasanZakatPerdagangan({Key, key, this.nominal, this.pembayaran})
      : super(key: key);
  @override
  _RingkasanZakatPerdaganganState createState() =>
      _RingkasanZakatPerdaganganState();
}

class _RingkasanZakatPerdaganganState extends State<RingkasanZakatPerdagangan> {
  @override
  signOut() async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    setState(() {
