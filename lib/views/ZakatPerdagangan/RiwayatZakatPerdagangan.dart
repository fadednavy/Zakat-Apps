...
class RiwayatZakatPerdagangan extends StatefulWidget {
  @override
  _RiwayatZakatPerdaganganState createState() =>
      _RiwayatZakatPerdaganganState();
}

class _RiwayatZakatPerdaganganState extends State<RiwayatZakatPerdagangan> {
  ...
  Future<void> _lihatData() async {
    ...
    final responseData = await http.post(
        Uri.parse(BaseURL.apiListZakatPerdagangan + idUsers),
        body: {"userid": idUsers});
