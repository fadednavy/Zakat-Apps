...
class RiwayatZakatHarta extends StatefulWidget {
  @override
  _RiwayatZakatHartaState createState() => _RiwayatZakatHartaState();
}

class _RiwayatZakatHartaState extends State<RiwayatZakatHarta> {
  ...
  Future<void> _lihatData() async {
    ...
    final responseData = await http.post(
        Uri.parse(BaseURL.apiListZakatHarta + idUsers),
        body: {"userid": idUsers});
