...
class TambahZakatHarta extends StatefulWidget {
  @override
  _TambahZakatHartaState createState() => _TambahZakatHartaState();
}

class _TambahZakatHartaState extends State<TambahZakatHarta> {
  ...
  simpanTransaksi() async {
    try {
      final response = await http.post(Uri.parse(BaseURL.addZakatHarta),
        ...
        setState(() {
          var route = new MaterialPageRoute(
            builder: (BuildContext context) =>
                new RingkasanZakatHarta(nominal: nominal, pembayaran: metodeID),
          );
...
class RingkasanZakatHarta extends StatefulWidget {
  final String nominal, pembayaran;

  RingkasanZakatHarta({Key, key, this.nominal, this.pembayaran})
      : super(key: key);
  @override
  _RingkasanZakatHartaState createState() => _RingkasanZakatHartaState();
}

class _RingkasanZakatHartaState extends State<RingkasanZakatHarta> {
  @override
  signOut() async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    setState(() {
